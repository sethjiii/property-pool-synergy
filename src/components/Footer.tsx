      ...
      <div className="container mx-auto py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">SpaceXec</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              The future of property investment through fractional ownership. 
              Breaking barriers in real estate and making premium assets accessible to everyone.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@spacexec.com" className="text-muted-foreground hover:text-primary transition-colors">
                  info@spacexec.com
                </a>
              </li>
            </ul>
